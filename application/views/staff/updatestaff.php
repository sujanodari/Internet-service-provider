...
<form action = "<?php echo base_url();?>update/users" method="post" style="margin:0; padding-top:0px">
     ...
     <legend>Update Customer</legend>
	 	  <p><label>Customer Username</label>
	  	  <select name="usern">
	  						<?php
...
<form  action = "<?php echo base_url();?>view/password" method="post" style="margin:0; padding-top:0px">
     <fieldset>
     <legend>View Customer Password</legend>
 <p><label>Customer Username</label>
	  <select name="usern" >
	  						<?php
			foreach($userlist->result_array() as $users):
...
<form  action = "<?php echo base_url();?>update/usersBandwidth" method="post" style="margin:0; padding-top:0px">
     <fieldset>
     <legend>Update Customer Bandwidth</legend>
 <p><label>Customer Username</label>
	  <select name="usern" >
	  						<?php
			foreach($userlist->result_array() as $users):
...
<div class="wrapper">
     <span class="group-btn">     
	<button class="fa fa-sign-in" type="submit" name="btn_view" class="registerpass">Update</button> 
       </span>
      </div>  	
    </fieldset>
	</form>
	            ...
	            <div class="form-login">                                               
<form  action = "<?php echo base_url();?>view/customerprofile" method="post" style="margin:0; padding-top:0px">
     <fieldset>
     <legend>View Customer profile</legend>
 <p><label>Customer Username</label>
	  <select name="name" >
	  						<?php
			foreach($userlist->result_array() as $users):
